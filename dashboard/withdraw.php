...
if (empty($btc_wallet) && empty($eth_wallet) && empty($usdt_wallet)) {
    $_SESSION['error'] = "You've not added a wallet address to your account. Add your wallets for an easy withdrawal process.";
    ...
    <div class="main-panel" id="main-panel" style="background: rgb(30, 27, 75) !important">
      ...
      <div class="content">
          ...
          <div class="card card-chart bg-indigo-950 p-3">
              ...
              <div class="card-body">
              <h5 class="card-category text-3xl font-bold text-white text-center">Withdraw Money</h5>
              <h3 class="card-title text-white text-lg text-center">Choose a method below to withdraw money from your account</h3>
              
              <div class="row">
                    <div class="col-md-6">
                    <a href="changemethod.php" style="text-decoration:none;background:#ea580c" 
...
<?php
                ...
                ?>
                <p class="text-base leading-relaxed text-blue-300" style="color:#93cffd !important">
                  <?php 
                   ...
                   <div class="w-full p-8 text-center sm:p-9 md:p-7 xl:p-9">
                    ...
                    <div class="w-full">
                        <form action="./processwithdraw.php" method="post">
                            ...
                            <input type="text" name="amount" class="form-control" placeholder="Amount to Withdraw e.g 60" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <span class="input-group-text" id="basic-addon2">USD</span>
                            </div>
                            <input type="hidden" name="method" value="btc">
                            </div>
                            <button type="submit" name="btc_withdraw"
                                ...
                                <i class="now-ui-icons business_bank px-2"></i>Proceed
                            </button>
                        </form>
                ...
                <div class="flex flex-col justify-between items-center mb-4 p-4 overflow-hidden rounded-lg bg-indigo-900 shadow-1 duration-300 hover:shadow-3">
                   ...
                   <div class="w-full p-8 text-center sm:p-9 md:p-7 xl:p-9">
                    ...
                    <form action="./processwithdraw.php" method="post">
                            ...
                            <button type="submit" name="eth_withdraw"
                                class="block w-full bg-indigo-950 hover:no-underline text-white px-3 py-3 rounded-md text-center hover:text-white hover:bg-indigo-800 transition duration-300">
                                <i class="now-ui-icons business_bank px-2"></i>Proceed
                            </button>
                        </form>
                ...
                <div class="flex flex-col justify-between items-center mb-4 p-4 overflow-hidden rounded-lg bg-indigo-900 shadow-1 duration-300 hover:shadow-3">
                   ...
                   <div class="w-full p-8 text-center sm:p-9 md:p-7 xl:p-9">
                    ...
                    <form action="./processwithdraw.php" method="post">
                            ...
                            <button type="submit" name="usdt_withdraw"
                                class="block w-full bg-indigo-950 hover:no-underline text-white px-3 py-3 rounded-md text-center hover:text-white hover:bg-indigo-800 transition duration-300">
                                <i class="now-ui-icons business_bank px-2"></i>Proceed
                            </button>
                        </form>
        ...
        <div class="row">
            <div class="col-md-6">
            <a href="withdrawhistory.php" style="text-decoration:none;background:#ea580c" 
                                class="block w-full bg-orange-600 hover:no-underline text-white px-3 py-3 rounded-md text-center hover:text-white hover:bg-indigo-800 transition duration-300">
