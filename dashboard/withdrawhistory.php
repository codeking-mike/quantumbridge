            ...
            <div class="row" style="background:#3730a3 !important">
                    <div class="col-lg-12 " style="background:#3730a3 !important">
                            <div class="card card-chart p-3" style="background:#3730a3 !important">
                                ...
                                <div class="card-body">
                                <h5 class="card-category text-3xl font-bold text-white text-center">Withdrawal History</h5>
                                <h3 class="card-title text-white text-lg text-center">View the status of your withdrawal requests</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
					  $check_dep = "SELECT * FROM client_withdrawals WHERE receiver='$username'";
						...
						if(mysqli_num_rows($res_dep) > 0 ){
							...
							echo "<tr style='color:white !important'>
							        <td>USD$with_amount in $method</td>
									<td>$date_withdrawn</td>
                                    
                                    <td><span style='color:yellow !important'>$completed</status></td>
