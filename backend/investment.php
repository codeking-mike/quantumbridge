...
if(isset($_GET['del'])){
    ...
    $del = $_GET['del'];
    mysqli_query($conn, "DELETE FROM client_deposit WHERE transid = '$del'");
}
?>
<!doctype html>
<html lang="en">
            ...
            <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background:#000 !important;">
                            <div class="header">
                                <h4 class="title" style="color:#fff">DEPOSIT REQUEST</h4>
                                <p class="category"></p>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td><?php echo $fund_amount ?></td>
                                        	<td><a href='investment.php?del=<?php echo $transid ?>'>DELETE</a></td>
                                        	<td><a href='viewpop.php?trans=<?php echo $transid ?>'>VIEW DETAILS</a></td>
                                        </tr>
                                        <?php
                                             }
                                             mysqli_close($conn);
