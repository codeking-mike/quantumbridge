...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $wallet_query = "SELECT wallet_address from central_account WHERE method='usdt'";
    ...
    <div class="main-panel" id="main-panel" style="background: rgb(30, 27, 75) !important">
      ...
      <div class="content">
          ...
          <div class="card card-chart bg-indigo-950 p-3">
              ...
              <div class="card-body">
              <h5 class="card-category text-3xl font-bold text-white text-center">USDT(TRC20) Deposit</h5>
            ...
            <div class="row flex-wrap flex-col md:flex-row col-md-10">
                ...
                <div class="flex flex-col p-4 justify-between items-center mb-4 overflow-hidden rounded-lg bg-indigo-900 shadow-1 duration-300 hover:shadow-3">
                   ...
                   <div class="w-full flex-1 text-left">
                    <p class="paragraph text-white mb-10">You have requested a deposit of <span class="text-orange-600"><?php echo $amount ?>USD</span> in USDT using the TRC20 network. Kindly use the details 
                    below to make deposit. 
                    </p>
                    <p class="text-white mb-10">Please ensure you send only USDT using the Tron(TRC20 netwokr) to the wallet address provided, sending any other coins will result in permanent loss.</p>
